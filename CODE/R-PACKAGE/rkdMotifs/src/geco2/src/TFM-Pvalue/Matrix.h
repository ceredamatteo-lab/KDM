...
////UBIO
  ...
  void clean(){
//     cout << "cleaning..." << endl;
//     cout << "matInt\t" << matInt << endl;
//     cout << "offsets\t" << offsets << endl;
//     cout << "minScoreColumn\t" << minScoreColumn << endl;
//     cout << "minScoreColumn\t" << maxScoreColumn << endl;
//     cout << "sum\t" << sum << endl;
//     cout << "bestScore\t" << bestScore << endl;
//     cout << "worstScore\t" << worstScore << endl;
