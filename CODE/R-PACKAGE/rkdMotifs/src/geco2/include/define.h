...
typedef u_int16_t  _unsigned_short;
...
typedef u_int32_t    _unsigned_int;
...
typedef u_int64_t  _unsigned_long;
...
/** @typedef float gStype;
 *  @brief Typedef used to represent floating point type used in GPU implemented methods */
#if GECO_LINALG_DOUBLE
