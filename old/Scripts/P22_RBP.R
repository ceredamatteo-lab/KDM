...
load(paste0(data_folder,"confronto_tomtom_kdmtom_factorbook_old.Rdata"))
p3<-plotClassification(tt1,"KDM",5)
pdf(paste0(plot_folder,"tmp_old_TF.pdf"),height = 8,width = 10)
ggarrange(plotlist=p3,nrow=1)
dev.off()
