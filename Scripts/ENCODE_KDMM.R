...
pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_01.pdf"),width = 7,height = 7)
p1
dev.off()

pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_02.pdf"),width = 10,height = 5)
p2
dev.off()

pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_03A.pdf"),width = 15,height = 5)
p3A
dev.off()

pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_03B.pdf"),width = 15,height = 5)
p3B
dev.off()

pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_04.pdf"),width = 7,height = 7)
p4
dev.off()
...
pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_05.pdf"),width = 10,height = 10)
pA
dev.off()
...
pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_06.pdf"),width = 10,height = 5)
pB
dev.off()
...
pdf(paste0("Figure/ENCODE_Dataset/KDMM/",exp,"_KDMM_07.pdf"),width = 10,height = 5)
pC
dev.off()
