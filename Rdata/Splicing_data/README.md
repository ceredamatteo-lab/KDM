...
03. **RBPname_CellLine_Genome_ridge.rds** : this Rdata objects is a list that contains multiple object genreated through the analysis
  ...
  - *profile* : score of each MRMD in each position of each subregion on both altered and control regions
  - *test*: overrepresentation results of each MRMD in each subregion
  - *pwm*s: MRMD to PWM convertion of each MRMD
  - *kdmtom*: results for the comparison betweeen each MRMDs and mCross PWMs converted into MRMD
